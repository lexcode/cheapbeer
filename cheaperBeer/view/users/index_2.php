...
<div class="row">
    <div class="col-lg-3">
        <div class="col-md-12 super-item main_column" id="1"><h1>Super Powers</h1></div>
        <div class="col-md-12 "  id="field_main1">
          ...
          <i class="icon-group icon-5x" style=" color:#cead00;"></i>
          <p><?php echo $tv['txt_service_support'] ;?></p>
          
          <h2><?php echo $tv['service_money'] ;?></h2>
          <i class="icon-money icon-5x" style=" color:#cead00;"></i>
    ...
    <div class="col-lg-5">
        <div class="col-md-12 super-item main_column" id="2"><h1>Service</h1></div>
        <div class="col-md-12"  id="field_main2">
       ...
       <BR>
          <div class="row">
              <a class="add-cart" href="#addcart<?php echo $k; ?>" role="button" data-id="<?php echo $k; ?>">
              <div class="col-md-12">
    ...
    <div class="col-lg-4" >
        <div class="col-md-12 super-item main_column" id="3"><h1>Order</h1></div>
        <?php echo $this->Form->create(array('style'=>'hoz','id'=>'field_main3','action'=>'users/signup'),true, '1987paka','777kikju') ;?>
