            ...
            <table cellspacing="0" cellpadding="0" width="400">
                <tbody><tr>
                    <td align="left" height="60">
                        <h2 style="font:bolder 24px/27px Arial, sans-serif;padding:0 0 10px;color:#0C695D;"><a href="<?php echo Router::url('users/index') ;?>" style="text-decoration:none;color:#0C695D;" target="_blank">CheaperBeer</a></h2>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="left" valign="top" style="padding:0 0 15px 0;">
                        <font size="4" color="#333" face="Helvetica Neue, Arial, Helvetica, sans-serif" style="font-size:16px;line-height:25px;">Welcome to CheaperBeer, kris972 (guizmauh@hotmail.com).
                        </font>
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="top" style="padding:0 0 15px 0;">
                        <font size="4" color="#333" face="Helvetica Neue, Arial, Helvetica, sans-serif" style="font-size:16px;line-height:25px;"><a href="http://www.simplewebagency.com/users/confirm/<?php echo $data['data'].'/'.$data['key'] ;?>" style="color:#0C695D" target="_blank"><?php echo $this->s['whois'] ;?></a>
                        </font>
                    </td>
                </tr>
                <tr>
