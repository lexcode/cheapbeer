    ...
    <tbody><tr>
        <td align="center" valign="top">
            ...
            <table cellspacing="0" cellpadding="0" width="400">
                ...
                <tr>
                    <td align="left" valign="top" style="padding:0 0 15px 0;">
                        <font size="4" color="#333" face="Helvetica Neue, Arial, Helvetica, sans-serif" style="font-size:16px;line-height:25px;"><?php echo $this->s['invit_joining'] ;?><br><a href="http://www.simplewebagency.com/invitations/join/<?php echo $data['theid'] ;?>" style="color:#0C695D;" target="_blank"><?php echo $this->s['click_2_joining'] ;?></a>
                        </font>
                    </td>
                </tr>
                <tr>
